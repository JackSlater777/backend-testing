...
allure_id=12
allure_endpoint=https://allure.my_server.ru
git_endpoint=https://my_bitbucket_server.ru
...
printf "\nRC version: $APP_VERSION \n"
app_version=$(echo $APP_VERSION | awk '{gsub(v.|-rc, "", $0); print $0}')
...
allurectl_result="$(./cats_core/allurectl upload $ALLURE_RESULTS --launch-tags "$app_name, $app_version, $variablefiles")"
